...
SPFT.numDays=1; %number of days of performance data that is available
SPFT.numTrials=3; %trials per block
SPFT.numBlocks=3; %num blocks
...
% end
% SPFT.IDs=IDs;
% subjectID` s without P01:

subjectDirs={'KP8T','OL1T','GAIT','LM8T','BI3T','WSFT','KSYT','MART','HCBT','JMCT','KPFT','NMFT','SCZT','PMIT','SJ6X','BP4T'}; 
IDs={'P02','P03','P04','P05','P06','P07','P08','P09','P10','P11','P12','P14', 'P16','P17','P18','P20'}; %Participants 13 and 15 are controls
...
for ID=1:length(IDs)
    ...
    for day=1:SPFT.numDays
        temp.fname=strcat(SPFT.dataDir,subjectDirs{ID},'/bx/',IDs{ID},'_d',num2str(day),SPFT.fileNameTail); %figure out what the trial name should be
        ...
        if exist(temp.fname,'file')==2
            ...
            try
                ...
                elseif strcmp(IDs{ID},'P17') && day==3 %for P11 maxvalue is also missing
                    ...
                    fprintf('%% temp.maxVal manually set to %i for %s, day %i\n',temp.maxVal,IDs{ID},day);
                    fprintf('%%========================================================%%\n\n');
                 elseif strcmp(IDs{ID},'P17') && day==4 %for P11 maxvalue is also missing
                    temp.maxVal=444;
                    fprintf('%%========================================================%%\n');
                    fprintf('%% temp.maxVal manually set to %i for %s, day %i\n',temp.maxVal,IDs{ID},day);
                    fprintf('%%========================================================%%\n\n');
...
ID=1;
days=1:6; %vector of days that I want to plot data for
...
plot([9.5 9.5], [min([nanmean(theDataLRN5), nanmean(theDataSMP5)]),max([nanmean(theDataLRN5), nanmean(theDataSMP5)])],'k:');
